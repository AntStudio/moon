...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="{fileName}" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '</form>' +
        ...
        init: function (editor, $w) {
            ...
            me.editor = editor;
            me.dialog = $w;
            me.render(".edui-image-local", 1,editor.options.imageFieldName);//me.editor.getOpt("imageFieldName") Gavin修改于2014-11-27，用于读取imageFieldName配置
        ...
        render: function (sel, t,f) {
            var me = this;

            $(sel, me.dialog).append($(me.uploadTpl.replace(/%%/g, t).replace(/{fileName}/g,f)));
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                //Gavin添加，用于自定义配置文件上传表单项名字和自定义数据格式化
                var form = new FormData();
                form.append("files",$('input[type=file].edui-image-file')[0].files[0]);
                $.ajax({
                    url:me.editor.getOpt("imageUrl"),
                    type:"Post",
                    data:form,
                    dataType:"json",
                    ...
                    if(me.editor.getOpt("imageCallBack")){
                        data = me.editor.getOpt("imageCallBack").call(me,data);
                    }
